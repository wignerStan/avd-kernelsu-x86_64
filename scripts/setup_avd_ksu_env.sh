...
KSU_DIR="${2:-/Users/jacob/tmp/mumu_sub/avd_ksu}"
SDK="${ANDROID_SDK_ROOT:-/Users/jacob/Library/Android/sdk}"
...
PY=/Users/jacob/.workbuddy/binaries/python/envs/default/bin/python
